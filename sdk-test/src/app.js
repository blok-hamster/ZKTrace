...
//0x23142E15b262D787344671C4B079A0510C682527 verifier1
//0x81D488Afdca5cAaCbe190608Cd819f59Af6Bd16A verifier2

// const verifier1key =
//   "0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d";
const verifier2key = process.env.VERIFIER_2_KEY;
const verifier3key =
  "0x7c852118294e51e653712a81e05800f419141751be58f605c371e15141b007a6";

const traceClient = new ZkTrace({
  nodeEndpoint: process.env.RPC_URI,
...
const acceptProposal = async () => {
  (async () => {
    ...
    const wallet = new Wallet(process.env.VERIFIER_2_KEY);
...
const verifyByOrder = async () => {
  (async () => {
    ...
    if (verifier === "first") {
      verifierKey = process.env.PRIVATE_KEY /*verifier1key*/;
...
const readData = async () => {
  (async () => {
    const cid = await promptly.prompt("Enter CID: ");
    const key = await promptly.password("Enter KEY: ", { replace: "*" });
